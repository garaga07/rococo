export const Errors = {
    ...
    SURNAME_LENGTH_CONSTRAINT_MIN: "Фамилия не может быть короче 3 символов",
    SURNAME_LENGTH_CONSTRAINT_MAX: "Фамилия не может быть длиннее 255 символов",
    ...
    BIOGRAPHY_LENGTH_CONSTRAINT_MIN: "Биография не может быть короче 11 символов",
    BIOGRAPHY_LENGTH_CONSTRAINT_MAX: "Биография не может быть длиннее 2000 символов",
    DESCRIPTION_LENGTH_CONSTRAINT_MIN: "Описание не может быть короче 11 символов",
